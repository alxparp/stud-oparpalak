...
public class TransportDaoImplTest {
    ...
    protected static TransportDaoImpl transportDao;

    @BeforeClass
    public static void init() throws FileNotFoundException, SQLException {
        emf = Persistence.createEntityManagerFactory("transport-test");
        em = emf.createEntityManager();
        transportDao = new TransportDaoImpl(em);
    }
    ...
    public void initializeDatabase(){
        ...
        session.doWork(new Work() {
            ...
            public void execute(Connection connection) throws SQLException {
                try {
                    File file = new File("src/it/resources/transport-data.sql");
    ...
    public void testSaveTransport() {
        ...
        Transport transport = new Transport("BMW", 27000, true, producer);
        transport.setId(5);
